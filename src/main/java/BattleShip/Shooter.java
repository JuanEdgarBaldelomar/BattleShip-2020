...
public class Shooter {
    	...
    	if(this.id==1) {
    		do {
                ...
                if(x>0 && y>0 && x<board.getRow()+1 && y<board.getCol()+1) 
                {
                	...
                	if (board.getPosition(x,y) == '-') {
                        ...
                        System.out.println("Ya has disparado aqu�...");
                        shooted=true;
                        board.printBoard();
                    }
                	...
                	System.out.println("Error.Introducir un n�mero del 1 al 5.");
                	shooted=false;
                }
           ...
           // x = rand.nextInt(board.getRow());
            ...
            if (board.getPosition(x,y) == '-') {
                ...
                System.out.println("CPU ya habia disparado aqu�...");
            }
	...
	/**
	 * M�todo que llama a getCoordinates para realizar un turno y nos 
